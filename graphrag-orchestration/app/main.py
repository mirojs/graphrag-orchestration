...
from app.hybrid_v2.routers.document_lifecycle import router as document_lifecycle_router
from app.hybrid_v2.routers.maintenance import router as maintenance_router
