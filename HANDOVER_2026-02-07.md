...
**Status:** ✅ Deployed at 2026-02-07 evening

**Deployed commits:** `2df6a121` → `82cf0c74` → `1e522668`

**Endpoint:** https://graphrag-api.salmonhill-df6033f3.swedencentral.azurecontainerapps.io

**Deploy time:** 2 minutes 28 seconds

All three services deployed successfully:
- graphrag-api (public endpoint)
- graphrag-api-b2c (B2C endpoint)
- graphrag-worker (internal)

### 7. `include_context` Feature (All Routes)
...
### 8. Sentence-Level Citations for Route 2
...
### 9. Q-G5 Root Cause: Proven with Graph Evidence
...
### Route 2 Double-Fetch (Low Priority)
...
**Decision:** Defer implementation until after Route 2/3/4 benchmark testing to avoid introducing any variables during validation.
...
1. ✅ ~~Deploy to Azure Container Apps~~ — COMPLETED 2026-02-07 evening
...
```bash
# Workspace maintenance (run weekly or when disk >90%)
