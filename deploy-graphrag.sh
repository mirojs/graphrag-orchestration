...
ROUTE7_RERANK_ALL=${ROUTE7_RERANK_ALL:-0}
# Route 7 entity synonymy threshold for cross-doc PPR bridges (§47)
ROUTE7_SYNONYM_THRESHOLD=${ROUTE7_SYNONYM_THRESHOLD:-0.70}
# Route 7 cross-encoder supplemental passage seeds (§46)
ROUTE7_SEMANTIC_PASSAGE_SEEDS=${ROUTE7_SEMANTIC_PASSAGE_SEEDS:-1}
ROUTE7_SEMANTIC_SEED_TOP_K=${ROUTE7_SEMANTIC_SEED_TOP_K:-20}
ROUTE7_SEMANTIC_SEED_WEIGHT=${ROUTE7_SEMANTIC_SEED_WEIGHT:-0.05}
# Route 7 triple reranking
ROUTE7_TRIPLE_RERANK=${ROUTE7_TRIPLE_RERANK:-1}
ROUTE7_TRIPLE_CANDIDATES_K=${ROUTE7_TRIPLE_CANDIDATES_K:-50}
ROUTE7_TRIPLE_TOP_K=${ROUTE7_TRIPLE_TOP_K:-15}
ROUTE7_ENTITY_SEED_TOP_K=${ROUTE7_ENTITY_SEED_TOP_K:-15}
ROUTE7_DPR_TOP_K=${ROUTE7_DPR_TOP_K:-50}
ROUTE7_PPR_PASSAGE_TOP_K=${ROUTE7_PPR_PASSAGE_TOP_K:-20}
# Route 7 synthesis prompt variant (v3_keypoints = bullet-points only, 60% less verbose)
ROUTE7_PROMPT_VARIANT=${ROUTE7_PROMPT_VARIANT:-v3_keypoints}
...
ENV_VARS=(
    ...
    ROUTE7_SYNONYM_THRESHOLD="$ROUTE7_SYNONYM_THRESHOLD"
    ROUTE7_SEMANTIC_PASSAGE_SEEDS="$ROUTE7_SEMANTIC_PASSAGE_SEEDS"
    ROUTE7_SEMANTIC_SEED_TOP_K="$ROUTE7_SEMANTIC_SEED_TOP_K"
    ROUTE7_SEMANTIC_SEED_WEIGHT="$ROUTE7_SEMANTIC_SEED_WEIGHT"
    ROUTE7_TRIPLE_RERANK="$ROUTE7_TRIPLE_RERANK"
    ROUTE7_TRIPLE_CANDIDATES_K="$ROUTE7_TRIPLE_CANDIDATES_K"
    ROUTE7_TRIPLE_TOP_K="$ROUTE7_TRIPLE_TOP_K"
    ROUTE7_ENTITY_SEED_TOP_K="$ROUTE7_ENTITY_SEED_TOP_K"
    ROUTE7_DPR_TOP_K="$ROUTE7_DPR_TOP_K"
    ROUTE7_PPR_PASSAGE_TOP_K="$ROUTE7_PPR_PASSAGE_TOP_K"
    ROUTE7_PROMPT_VARIANT="$ROUTE7_PROMPT_VARIANT"
