#!/usr/bin/env python3
"""
Test invoice consistency query on all KNN configurations via API.

Tests the query on all 5 groups using the /hybrid/query API endpoint.
"""
    ...
    try:
        ...
        if citations:
            ...
            for i, citation in enumerate(citations[:5], 1):
                ...
                text_preview = citation.get('text_preview', '')[:200].lower()
...
async def main():
    ...
    with open("knn_invoice_test_results.json", "w") as f:
