...
async def debug_neo4j(request: Request):
    ...
    try:
        ...
        sample_properties = {}
        key_labels = ["Entity", "__Node__", "Chunk", "Document", "Entity"]
...
async def index_file_v2(request: Request, payload: V2IndexFileRequest):
    ...
    try:
        ...
        from app.services.neo4j_graphrag_service import get_neo4j_graphrag_service
...
async def debug_neo4j_v2(request: Request):
    ...
    try:
        ...
        with driver.session() as session:
            ...
            # Get sample node properties for key labels
            sample_properties = {}
            key_labels = ["Entity", "__Node__", "Chunk", "Document", "Entity", "__Chunk__"]
