...
DENOISE_SCORE_WEIGHTED=${DENOISE_SCORE_WEIGHTED:-0}
DENOISE_COMMUNITY_FILTER=${DENOISE_COMMUNITY_FILTER:-0}
COMMUNITY_PENALTY=${COMMUNITY_PENALTY:-0.3}
DENOISE_SCORE_GAP=${DENOISE_SCORE_GAP:-0}
SCORE_GAP_THRESHOLD=${SCORE_GAP_THRESHOLD:-0.5}
SCORE_GAP_MIN_KEEP=${SCORE_GAP_MIN_KEEP:-6}
DENOISE_SEMANTIC_DEDUP=${DENOISE_SEMANTIC_DEDUP:-0}
SEMANTIC_DEDUP_THRESHOLD=${SEMANTIC_DEDUP_THRESHOLD:-0.85}
...
ENV_VARS=(
    ...
    ROUTE3_DENOISE_COMMUNITY_PROMPT="$ROUTE3_DENOISE_COMMUNITY_PROMPT"
)
