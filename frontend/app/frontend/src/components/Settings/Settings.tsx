            ...
            {showAgenticRetrievalOption && useAgenticKnowledgeBase && (
                <div className={styles.settingsField}>
                    ...
                    <Dropdown
                        ...
                        value={retrievalReasoningOptions.find(o => o.key === agenticReasoningEffort)?.text || ""}
                    ...
                    >
                        {retrievalReasoningOptions.map(o => (
            ...
            {showQueryRewritingOption && !useAgenticKnowledgeBase && (
                <>
                    <div className={styles.settingsCheckbox}>
                        ...
                        />
                        <HelpCallout labelId={queryRewritingId} fieldId={queryRewritingFieldId} helpText={t("helpTexts.useQueryRewriting")} label={t("labels.useQueryRewriting")} />
                    </div>
                </>
            )}
            {showReasoningEffortOption && (
                <div className={styles.settingsField}>
                    <HelpCallout labelId={reasoningEffortId} fieldId={reasoningEffortFieldId} helpText={t("helpTexts.reasoningEffort")} label={t("labels.reasoningEffort")} />
                    <Dropdown
                        id={reasoningEffortFieldId}
                        selectedOptions={[reasoningEffort]}
                        value={reasoningEffortOptions.find(o => o.key === reasoningEffort)?.text || ""}
                        onOptionSelect={(_ev: SelectionEvents, data: OptionOnSelectData) =>
                            onChange("reasoningEffort", data.optionValue || "")
                        }
