...
def _get_query_embedding(query: str) -> List[float]:
    """Get embedding for a query string (V2: Voyage voyage-context-3 or fallback to OpenAI)."""
    from src.worker.hybrid_v2.orchestrator import get_query_embedding as v2_embed
    return v2_embed(query)
