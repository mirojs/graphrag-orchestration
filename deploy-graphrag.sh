...
# Route 3 denoising defaults — all ON (proven in Feb 2026 ablation study).
# Steps D1-D4 are safe for all datasets. Set to 0 to disable for debugging.
ROUTE3_DENOISE_DEDUP=${ROUTE3_DENOISE_DEDUP:-1}
ROUTE3_DENOISE_NOISE_FILTER=${ROUTE3_DENOISE_NOISE_FILTER:-1}
ROUTE3_DENOISE_PPR_SCORING=${ROUTE3_DENOISE_PPR_SCORING:-1}
ROUTE3_DENOISE_TOKEN_BUDGET=${ROUTE3_DENOISE_TOKEN_BUDGET:-1}
...
ENV_VARS=(
    ...
    ROUTE3_DENOISE_DEDUP="$ROUTE3_DENOISE_DEDUP"
    ROUTE3_DENOISE_NOISE_FILTER="$ROUTE3_DENOISE_NOISE_FILTER"
    ROUTE3_DENOISE_PPR_SCORING="$ROUTE3_DENOISE_PPR_SCORING"
    ROUTE3_DENOISE_TOKEN_BUDGET="$ROUTE3_DENOISE_TOKEN_BUDGET"
)
